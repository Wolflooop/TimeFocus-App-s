...
<tr>
<td width="50%" align="center"><img src="./assets/logoOficialUTXJSombra.png" width="150"> </td>
<td width="50%" align="center"><img src="./assets/LOGO TI 2025_ SIN FONDO.png" width="150"> </td>
</table>
...
<p align="justify"><strong>Gestión de tareas</strong>: Permitir la creación, edición, eliminación y seguimiento de tareas académicas.</p>

<p align="justify"><strong>Implementación de Pomodoro</strong>: Integrar un temporizador configurable que facilite la concentración y el manejo del tiempo.</p>

<p align="justify"><strong>Modo offline</strong>: Permitir el uso de la aplicación sin conexión a internet mediante almacenamiento local.</p>

<p align="justify"><strong>Visualización de estadísticas</strong>: Mostrar el progreso del usuario a través de un dashboard.</p>

<p align="justify"><strong>Autenticación segura</strong>: Garantizar el acceso mediante login tradicional y Google Sign-In.</p>

---

### DIAGRAMA DE GANNT

<img src="assets/gantt.png" width="80%" style="padding: 10px;" />
...
<img src="assets/organigrama.png" width="80%" style="padding: 10px;" />
